...
# Project:  foo.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile foo.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++2a -Wall -Wextra -Warith-conversion -pedantic -g -ggdb -O3 -O2 -std=gnu++1z -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
COMPRESS      = gzip -9f
DISTNAME      = foo1.0.0
DISTDIR = /home/a31/Documents/Coding/C++/DnD/.tmp/foo1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath -Wl,-O1 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -rdynamic /usr/lib/x86_64-linux-gnu/libQt6Widgets.so /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = Main.cpp \
		QDatabaseInterface.cpp moc_QDatabaseInterfaceIntermediary.cpp \
		moc_QHomeInterface.cpp
OBJECTS       = Main.o \
		QDatabaseInterface.o \
		moc_QDatabaseInterfaceIntermediary.o \
		moc_QHomeInterface.o
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		foo.pro Constants.hpp \
		HexBitset.hpp \
		QDatabaseInterface.hpp \
		QDatabaseInterfaceIntermediary.hpp \
		QHomeInterface.hpp \
		Using.hpp Main.cpp \
		QDatabaseInterface.cpp
QMAKE_TARGET  = foo
DESTDIR       = 
TARGET        = foo
...
Makefile: foo.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Constants.hpp HexBitset.hpp QDatabaseInterface.hpp QDatabaseInterfaceIntermediary.hpp QHomeInterface.hpp Using.hpp $(DISTDIR)/
	$(COPY_FILE) --parents Main.cpp QDatabaseInterface.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++2a -Wall -Wextra -Warith-conversion -pedantic -g -ggdb -O3 -O2 -std=gnu++1z -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_QDatabaseInterfaceIntermediary.cpp moc_QHomeInterface.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_QDatabaseInterfaceIntermediary.cpp moc_QHomeInterface.cpp
moc_QDatabaseInterfaceIntermediary.cpp: QDatabaseInterfaceIntermediary.hpp \
		Using.hpp \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/a31/Documents/Coding/C++/DnD/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/a31/Documents/Coding/C++/DnD -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/7 -I/usr/include/x86_64-linux-gnu/c++/7 -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-linux-gnu/7/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/7/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include QDatabaseInterfaceIntermediary.hpp -o moc_QDatabaseInterfaceIntermediary.cpp

moc_QHomeInterface.cpp: QHomeInterface.hpp \
		Constants.hpp \
		Using.hpp \
		QDatabaseInterface.hpp \
		HexBitset.hpp \
		...
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/a31/Documents/Coding/C++/DnD/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/a31/Documents/Coding/C++/DnD -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/7 -I/usr/include/x86_64-linux-gnu/c++/7 -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-linux-gnu/7/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/7/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include QHomeInterface.hpp -o moc_QHomeInterface.cpp
...
Main.o: Main.cpp QHomeInterface.hpp \
		Constants.hpp \
		Using.hpp \
		QDatabaseInterface.hpp \
		HexBitset.hpp \
...
QDatabaseInterface.o: QDatabaseInterface.cpp Constants.hpp \
		Using.hpp \
		QDatabaseInterface.hpp \
		HexBitset.hpp \
		QDatabaseInterfaceIntermediary.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o QDatabaseInterface.o QDatabaseInterface.cpp

moc_QDatabaseInterfaceIntermediary.o: moc_QDatabaseInterfaceIntermediary.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_QDatabaseInterfaceIntermediary.o moc_QDatabaseInterfaceIntermediary.cpp

moc_QHomeInterface.o: moc_QHomeInterface.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_QHomeInterface.o moc_QHomeInterface.cpp
